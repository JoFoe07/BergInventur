...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.util.Region.partial": "touch/src/ux/TouchCalendarEvents.js",
  "Ext.ux.CalendarEventBarModel": "touch/src/ux/TouchCalendarEvents.js",
  "Ext.ux.field.DateTimePicker": "touch/src/ux/DateTimePicker.js",
  "Ext.ux.picker.DateTime": "touch/src/ux/DateTime.js",
  "TouchCalendarViewModel": "touch/src/ux/TouchCalendarView.js"
});
Ext.ClassManager.addNameAlternateMappings({
  "BergInventur.controller.LoginController": [],
  "BergInventur.controller.Search_Controller": [],
  "BergInventur.model.Model_ActivityLine": [],
  "BergInventur.model.Model_LagerMitarbeiterLogistic": [],
  "BergInventur.model.auftragsnummern": [],
  "BergInventur.store.Store_LagerMitarbeiterLogistic": [],
  "BergInventur.store.activityline": [],
  "BergInventur.store.artikelnummern": [],
  "BergInventur.view.Lagerfach": [],
  "BergInventur.view.Login": [],
  "BergInventur.view.Search_Container": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "BergInventur.model.Model_LagerMitarbeiterLogistic": [],
  "BergInventur.model.auftragsnummern": [
    "model.auftragsnummern"
  ],
  "BergInventur.store.Store_LagerMitarbeiterLogistic": [],
  "BergInventur.store.activityline": [],
  "BergInventur.store.artikelnummern": [
    "store.artikelnummern_liste"
  ],
  "BergInventur.view.Lagerfach": [
    "widget.lagerfach"
  ],
