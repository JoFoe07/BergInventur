...
Ext.define('Ext.ux.TouchCalendar',{
	...
	config: {
        /**
         * @cfg {String} helpHtml Hilfe für die App Angabe des Pfades der html Datei './resources/html/Planung.html'.
         */		
		helpHtml: '',
		/**
		...
		*/
        ...
        /**
         * @cfg {String} helpHtml hilfe für AD Angabe des Fades der html Datei.
         */		
		helpHtml: ''
	},
	...
	initialize: function(){
		...
		console.log('TouchCalendar initialize');
